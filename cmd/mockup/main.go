	...
	return &inventory.Inventory{
		...
		NICs: []inventory.NIC{
			{Name: "eno1", MAC: "b0:7b:25:1a:2c:3d", Speed: 10000, State: "up",
				IPs: []string{"10.20.4.71/24"}, PCI: "0000:19:00.0",
				Switch: "tor-a-r14", Port: "Ethernet1/7"},
			{Name: "eno2", MAC: "b0:7b:25:1a:2c:3e", State: "down", PCI: "0000:19:00.1"},
			{Name: "ens3f0", MAC: "b0:7b:25:1a:2c:4a", Speed: 25000, State: "up",
				IPs: []string{"192.168.40.71/24"}, PCI: "0000:5e:00.0",
				Switch: "tor-b-r14", Port: "Ethernet1/7"},
			{Name: "ens3f1", MAC: "b0:7b:25:1a:2c:4b", State: "down", PCI: "0000:5e:00.1"},
		},
		Disks: []inventory.Disk{
			{Path: "/dev/nvme0n1", Size: 1920383410176, Serial: "S6EWNG0T801234",
				Model: "SAMSUNG MZQL21T9HCJR-00A07", Type: "nvme", WWN: "eui.3634473052801234"},
			{Path: "/dev/nvme1n1", Size: 1920383410176, Serial: "S6EWNG0T801235",
				Model: "SAMSUNG MZQL21T9HCJR-00A07", Type: "nvme", WWN: "eui.3634473052801235"},
			{Path: "/dev/sda", Size: 960197124096, Serial: "PHYS7412000M960CGN",
				Model: "DELL PERC H755 Front", Type: "ssd", WWN: "naa.6d0946606b1b2c00"},
			{Path: "/dev/sdb", Size: 960197124096, Serial: "S6KHNA0T123456",
				Model: "SAMSUNG MZ7L3960HCJR", Type: "hdd", WWN: "0x5002538f31a1b2c3"},
		},
	}
}
